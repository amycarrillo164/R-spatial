...
saveRDS(NYC_HealthFacilties_SF, "data/SF/NYC_HealthFacilties_SF.rds")
saveRDS(food_retailsNY_SF, "data/SF/NYC_FoodRetail_SF.rds")
saveRDS(zipcode, "data/SF/NYC_Zipcode_SF.rds")

```

```{r}
# Save as a GeoPackage file
st_write(NYC_HealthFacilties_SF, "data/HW10.gpkg", "NYC_HealthFacilties_SF")
st_write(food_retailsNY_SF, "data/HW10.gpkg", "NYC_FoodRetail_SF")
st_write(zipcode, "data/HW10.gpkg", "NYC_Zipcode_SF")
